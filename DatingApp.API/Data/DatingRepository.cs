    ...
    public class DatingRepository : IDatingRepository
    {
        ...
        public async Task<User> GetUser(int id)
        {
            var user = await _context.Users.Include(p => p.Photos)
                .FirstOrDefaultAsync(u => u.Id == id); //default is null
        ...
        {
            return await _context.SaveChangesAsync() > 0; //returns count of saved records
        }
        ...
        {
            //is going to result in returning the conversation between two users
